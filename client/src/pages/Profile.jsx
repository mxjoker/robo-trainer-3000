...
export default function Profile() {
  ...
  async function seedDefaults() {
    ...
    try {
      ...
      alert("Day A/B/C/D templates loaded! They'll appear when you start a workout.")
    } catch {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.section}>
        ...
        <button style={s.navBtn} onClick={() => navigate('/exercises')}>
      ...
      <div style={s.divider} />
      <div style={{ ...s.sectionLabel, marginBottom: 16 }}>Settings</div>
      ...
      <div style={s.section}>
        ...
        <div style={s.card}>
          <button style={s.btn()} onClick={seedDefaults} disabled={seeding}>
            {seeding ? 'Loading...' : 'Load Day A / B / C / D Templates'}
          </button>
          <div style={s.hint}>Pre-fills Days A, B, C, D with standard exercises and starting weights.</div>
        </div>
      </div>
