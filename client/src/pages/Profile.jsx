        ...
        {routines.length === 0 ? (
          <div style={s.card}>
            <button style={s.btn()} onClick={seedDefaults} disabled={seeding}>
              {seeding ? 'Loading...' : 'Load Day A / B / C / D Defaults'}
            </button>
            <div style={s.hint}>Pre-fills Days A–D with standard exercises and starting weights.</div>
          </div>
        ) : (
          <>
